...
from causality.causal_discovery import causal_discovery, postprocess_cd
from train import train_models
from util import graph
from QIDLearningLib.metrics import performance as perf
from util.graph import plot_error_histogram, plot_error_histograms
...
class QuasiIdentifierApp:
    ...
    def plot_causal_graph(self):
        graph.plot_causal_graph(self.causal_graph_pre, self.causal_graph, self.dataset.columns)
